...
public class ServicoEstatisticaIntegracaoTest {

    @Test
    public void testCalculaEstatisticasComEstatisticaNormal() {
        ...
        eventos.add(new Evento(2,"Evento2", 3, 2, 2023, 4, 5, 6, 0)); // Distância 1, com outros valores de tempo
        eventos.add(new Evento(3,"Evento3", 2, 3, 2023, 2, 4, 5, 0)); // Distância 1, com valores de tempo
